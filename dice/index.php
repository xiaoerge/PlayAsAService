...
<head>
    ...
    <meta name="twitter:image" content="./assets/icons/ms-icon-310x310.png">
    <link rel="apple-touch-icon" sizes="./assets/icons/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="./assets/icons/apple-icon-60x60.png">
